...
ALLOWED_HOSTS = list(os.environ.get("DJANGO_ALLOWED_HOSTS", "127.0.0.1").split())
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'src.apps.artifact_auth.services.auth_backend.AuthBackend',
    ),
...
TELEGRAM_AUTH = {
    'BOT_TOKEN': os.environ.get('TELEGRAM_BOT_TOKEN', '0'),
}
